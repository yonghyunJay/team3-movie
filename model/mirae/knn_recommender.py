...
class KnnRecommender:
    ...
    def make_recommendations(self, fav_movie, n_recommendations):
        ...
        for rt in range(0, len(ran_title)):
            ...
            total_title.append(ran_title[rt])
...
if __name__ == '__main__':
    # get args
    args = parse_args()
    # movie_name2 = args.movie_name.split(',')
    #################사용자 입력 값 받는 부분 
    movie_name_ = 'superman, notting hills, interstella, the brave heart'
    movie_name2 = movie_name_.split(',')
